...
(defun princ-section-body (body)
  (do* ((list body (cdr list))
    ...
    (cond
     ((uiop:string-prefix-p ";;;; " elt) (format t "~%## ")
     ...
     ((uiop:string-prefix-p "#+syntax" elt) (format t "~%### ")
      (write-line (escape-* elt) *standard-output* :start 2))
     ((uiop:string-prefix-p "#+setf" elt) (write-string "### ")
      (write-line (escape-* elt) *standard-output* :start 2))
     ((uiop:string-prefix-p "#+signature" elt) (write-string "* ")
      (write-line (escape-* elt) *standard-output* :start 12))
     ((uiop:string-prefix-p "#| " elt) (write-string "# ")
